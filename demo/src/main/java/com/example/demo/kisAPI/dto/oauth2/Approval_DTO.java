...
public class Approval_DTO {
  ...
  public static class Req {
    ...
    private Req(@NonNull String grant_type, @NonNull String appkey, @NonNull String appsecret) {
    ...
    @NonNull
    public static Req from(@NonNull Account account) {
      ...
      return new Req("client_credentials", APP_KEY, APP_SECRET);
    }
  ...
  public static class Res {
    ...
    public Res(String access_token, String token_type, Long expires_in, String access_token_token_expired) {
